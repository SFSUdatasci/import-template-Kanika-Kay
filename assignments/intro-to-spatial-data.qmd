...
ak_rgns_sf <- read_sf(here("assignments/Data/ak_regions_simp.shp"))
```
...
pop_df <- read_csv(here("assignments/Data/alaska_population.csv"))
```
...
```{r}
rivers_3338_sf <- read_sf(here("assignments/Data/ak_rivers_simp.shp"))
```
